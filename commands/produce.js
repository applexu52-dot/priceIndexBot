...
export default async (event) => {
  try {
    ...
    soybean.body.contents[1].contents[1].text = (rssb.at(-1)).toFixed(3).toString()
    ...
    corn.body.contents[1].contents[1].text = (rscr.at(-1)).toFixed(3).toString()
    ...
    wheat.body.contents[1].contents[1].text = (rswht.at(-1)).toFixed(3).toString()
