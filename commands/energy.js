...
export default async (event) => {
    try {
        ...
        wtiOil.body.contents[1].contents[1].text = (rswti.at(-3)).toFixed(3).toString()
        ...
        bltOil.body.contents[1].contents[1].text = (rsbl.at(-3)).toFixed(3).toString()
        ...
        rboboil.body.contents[1].contents[1].text = (rsrb.at(-3)).toFixed(3).toString()
        ...
        gas.body.contents[1].contents[1].text = (rsgs.at(-3)).toFixed(3).toString()
